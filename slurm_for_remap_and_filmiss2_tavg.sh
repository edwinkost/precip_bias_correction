...
NC_INPUT_FILE="/scratch-shared/edwinhs/uly_forcing_files_v2024-02-XX_em-earth_era5land/tavg_daily_era5land_1981-2022.nc"
GRID_DES_FILE="/projects/0/dfguu/users/edwin/data/cdo_grid_description_files/global_grid_des_05min.txt"

NC_OUTPUT_FOLDER="/scratch-shared/edwin/era5land_uly_forcing_files_for_beda/tavg/"
mkdir -p ${NC_OUTPUT_FOLDER}
cd ${NC_OUTPUT_FOLDER}

NC_OUTPUT_PATTERN="tavg_daily_era5land-ulysses_05min"
